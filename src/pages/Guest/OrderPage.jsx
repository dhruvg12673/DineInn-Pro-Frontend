...
const OrderPage = ({ onBackToMenu, orderData, tableNo }) => {
  ...
  // This component now assumes orderData will always be present,
  // because Guest.jsx will only render it when there's an order to confirm.
  ...
  return (
    <div className="order-page-container">
      ...
      <div className="order-header">
        ...
        {/* The Success Message is the key part of this page */}
